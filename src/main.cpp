...
void gameOver(){
    ...
    std::cout<<"\t\t---------------------------"<<endl<<endl;
    std::cout<<"\t\tPress any the key to back to menu.";
    getch();
}
void updateScore(){
    gotoxy(WIN_WIDTH+7,5);std::cout<<"Score:"<<score<<endl;
...
void instructions(){
    ...
    std::cout<<"\n----------------";
    std::cout<<"\n Avoid Cars vy moving left or right. ";
